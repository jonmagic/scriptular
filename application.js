...
(function() {
  var $, App, Expression, Results, TestStrings, _ref, _ref1,
  ...
  TestStrings = (function(_super) {
    ...
    function TestStrings() {
      _ref1 = TestStrings.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  Results = (function() {
    ...
    Results.prototype.compile = function() {
      var count, error, matches, value, _i, _len, _ref2;
      $('ul#results').empty();
      $('ul#groups').empty();
      count = 1;
      ...
      try {
        _ref2 = this.test_strings.values;
    ...
    */
    ...
    Results.prototype.matchGroups = function(value, matches, count) {
      var match, _i, _j, _len, _len1, _ref2;
      if (!matches) {
        return;
      }
  ...
  App = (function() {
    ...
    App.prototype.loadFromHash = function() {
      var option, regex, test_strings_from_url, _ref2;
      _ref2 = decodeURIComponent(window.location.hash.substr(1)).split("||||"), regex = _ref2[0], option = _ref2[1], test_strings_from_url = _ref2[2];
